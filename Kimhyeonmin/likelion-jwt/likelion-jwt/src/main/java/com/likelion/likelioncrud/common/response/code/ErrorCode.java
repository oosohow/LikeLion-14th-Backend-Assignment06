...
public enum ErrorCode {
    ...
    //403 에러
    AI_READ_FORBIDDEN(HttpStatus.FORBIDDEN, "AI 파트는 게시글을 조회할 수 없습니다."),
    BACKEND_ONLY_FORBIDDEN(HttpStatus.FORBIDDEN, "게시글 작성/수정/삭제는 BE 파트만 가능합니다."),
    NOT_POST_OWNER_FORBIDDEN(HttpStatus.FORBIDDEN, "본인이 작성한 게시글만 수정 및 삭제할 수 있습니다."),
